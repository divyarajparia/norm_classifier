"""
Run Exp 2 (v4, flan-t5 only) on GPU 1.
Run: PYTHONNOUSERSITE=1 CUDA_VISIBLE_DEVICES=1 python run_v4_exp2.py
"""
...
print(f"\n>>> Exp 2: {'DONE' if result.returncode == 0 else 'FAILED'} in {(time.time()-start)/60:.1f} min")
