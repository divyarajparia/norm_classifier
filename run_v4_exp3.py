"""
Run Exp 3 (v4, flan-t5 only) on GPU 2.
Run: PYTHONNOUSERSITE=1 CUDA_VISIBLE_DEVICES=2 python run_v4_exp3.py
"""
...
print(f"\n>>> Exp 3: {'DONE' if result.returncode == 0 else 'FAILED'} in {(time.time()-start)/60:.1f} min")
